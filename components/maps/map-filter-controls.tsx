          ...
          >
            ...
            {hasActiveFilters && (
              <span className="bg-white text-navy rounded-full w-5 h-5 flex items-center justify-center text-xs font-bold">
                {selectedCategories.length + selectedCountries.length + (startYear !== null ? 1 : 0) + (endYear !== null ? 1 : 0)}
              </span>
            )}
          </button>
      ...
      {isOpen && (
        <div className="mt-4 p-4 border border-gray-200 rounded-lg bg-white shadow-sm">
          <div className="flex justify-between items-center mb-4">
            <h3 className="font-medium">Filter Map Locations</h3>
            <button
              onClick={handleToggleOpen}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            {/* Category filters */}
            <div>
              <h4 className="text-sm font-medium mb-2">Location Types</h4>
            ...
            {/* Time range filters */}
            <div>
              <h4 className="text-sm font-medium mb-2">Establishment Year</h4>
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          {(startYear !== null || endYear !== null) && (
            <div className="flex items-center gap-1 px-2 py-1 rounded-full text-xs text-white bg-navy">
              <span>
                Year: {startYear !== null ? startYear : '1933'} - {endYear !== null ? endYear : 'present'}
              </span>
              <button
                onClick={handleClearTimeRange}
                className="hover:bg-white/20 rounded-full p-0.5"
